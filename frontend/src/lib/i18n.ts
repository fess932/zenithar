...
const ru = {
  ...
  comingSoon: "Скоро",
  importPack: "Импорт пака (.wastickers / .tgs)",
  importing: "Импорт…",
  noPacks: "Паков пока нет. Импортируйте .wastickers или .tgs.",
  sharePack: "Поделиться паком",
  editPack: "Редактировать",
  deletePack: "Удалить пак",
  convertPack: "Перевести в WebP",
  deletePackConfirm: "Удалить пак? Его стикеры пропадут у вас.",
  removeItem: "Убрать",
  packs: "Паки",
  pack: "Пак",
  kindSticker: "Стикеры",
  kindGif: "Гифки",
  kindSaved: "Сохранёнки",
  addPackTitle: "Добавить пак себе?",
  addPack: "Добавить пак",
  packAdded: "Пак добавлен",
  packNotFound: "Пак не найден или ссылка устарела.",
  ...
  statDb: "БД",
  statDiskFree: "свободно",
  statDbSize: "Вес БД",
  statDisk: "На диске",
  statMemory: "Память",
  statLast24h: "за сутки",
  statLast7d: "за неделю",
  statRecorded: "с записью",
  statRecordings: "Записи",
  deleteRecordingConfirm: "Удалить запись звонка?",
  ...
  statAudio: "Аудио",
  statOther: "Другое",
  statNoData: "Не удалось загрузить статистику.",
  close: "Закрыть",
  noPeople: "Никого нет",
  onlineNow: "в сети",
...
const en: Record<keyof typeof ru, string> = {
  ...
  importPack: "Import a pack (.wastickers / .tgs)",
  importing: "Importing…",
  noPacks: "No packs yet. Import a .wastickers or .tgs.",
  sharePack: "Share pack",
  editPack: "Edit",
  deletePack: "Delete pack",
  convertPack: "Convert to WebP",
  deletePackConfirm: "Delete this pack? Its stickers will be gone for you.",
  removeItem: "Remove",
  packs: "Packs",
  pack: "Pack",
  ...
  kindGif: "GIFs",
  kindSaved: "Saved",
  addPackTitle: "Add this pack?",
  addPack: "Add pack",
  packAdded: "Pack added",
  packNotFound: "Pack not found or the link expired.",
  ...
  deleteRecordingConfirm: "Delete this call recording?",
  ...
  statAudio: "Audio",
  statOther: "Other",
  statNoData: "Couldn't load statistics.",
  close: "Close",
